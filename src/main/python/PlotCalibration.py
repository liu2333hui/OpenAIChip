...
def hua(logs_dir,
	valid_modules = {"Total":["total"], "PE":["PE"], "INTERCONNECT":["L1_WEI_MULTICAST", "L1_ACT_MULTICAST"], "L1":["L1_WEI_READ", "L1_WEI_WRITE","L1_ACT_READ", "L1_ACT_WRITE"], "L2": ["L2_WEI_READ", "L2_WEI_WRITE", "L2_ACT_READ", "L2_ACT_WRITE" ], "ADDER TREE": ["ADDER_ACCUM"],  },
