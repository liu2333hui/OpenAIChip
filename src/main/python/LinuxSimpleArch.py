...
class SimpleArch:#(AIChip):
	...
	def infer_fc_adder_accum(self,name,
		...
		prec = 2*(self.WEI_PREC + self.ACT_PREC)
		#print(prec)
		#exit()
		...
		if(True):
			...
			if(self.RUN_GOLDEN):
				...
				#with open(JSON_FILE, "w") as json_file:
					...
					#PE_TRACE_FILES = " ".join([PE_TRACE_FILE+"_"+str(i) for i in range(self.FC_PES//self.FC_TI)])
					#os.system(f'{SBT} "test:runMain accumulator.RegAccumulateNSpecFromFile {PE_TRACE_FILES} {JSON_FILE}" > golden.addern.log')
...
if __name__ == "__main__":
	...
	combos = []
	for ti in [ 2, 1,4, 8, 16]:
		for tn in [4,2,4,8, 16]:
			for tb in [1,2,4]:
